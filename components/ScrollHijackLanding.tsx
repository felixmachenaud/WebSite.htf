    ...
    >
      ...
      >
        ...
        <Link
          href="/"
          scroll={false}
          className="absolute left-1/2 flex -translate-x-1/2 items-center gap-2.5 font-serif text-2xl font-semibold text-slate-800 hover:text-slate-600"
        >
      ...
      {/* ========== MENU DÉROULANT (glissement gauche → droite) ========== */}
      <div
